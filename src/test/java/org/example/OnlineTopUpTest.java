...
public class OnlineTopUpTest {
    ...
    @Test
    @Story("Поля сервиса «Услуги связи» и кнопка «Продолжить»")
    @Severity(SeverityLevel.CRITICAL)
    @Description("Заполнение полей сервиса «Услуги связи» и проверить работу кнопки «Продолжить»")
    ...
    @Story("Виджет оплаты")
    @Severity(SeverityLevel.CRITICAL)
    @Description("Проверка корректности отображения суммы, номера телефона, плейсхолдеров полей для ввода реквизитов карты и наличие иконок платёжных систем")
